...
咖啡馆营收案例：Python 基础 → Pandas → 决策树 / 随机森林 → 评估与调参 → **经营证据、Flask 演示给老板看、结营**。
...
教学课程/
  ...
  day5/   经营证据、Flask 迷你演示（给老板看）、结营汇报
项目内容/  案例相关补充（可选）
```
...
- 主要库：`pandas`、`matplotlib`、`scikit-learn`（Day 3–5）
- Day 5 建议：`flask`（迷你预测网页；装不上可用 notebook 演示）
